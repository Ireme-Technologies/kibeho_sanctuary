...
class NewsPostSeeder extends Seeder
{
    public function run(): void
    {
        $posts = [
            ...
            [
                'slug' => 'assumption-2026-at-kibeho',
                'title' => 'Feast of the Assumption at Kibeho — 15 August',
                'excerpt' => 'Pilgrims from across Rwanda and beyond gather for Mass, procession, confession, and thanksgiving on the Assumption of the Blessed Virgin Mary.',
                'category' => 'Events',
                'tags' => ['Events', 'Feast Days', 'Assumption'],
                'author_name' => 'Shrine Communications',
                'author_avatar' => '/images/blog/authors/team.jpg',
                'author_role' => 'Shrine Communications',
                'author_bio' => 'News and updates from the pastoral team serving pilgrims at the Shrine of Our Lady of Kibeho.',
                ...
                'cover_image' => '/images/sanctuary/hero.jpg',
                'related_event_slug' => 'feast-of-the-assumption',
                'body' => '<p>Today the Shrine of Our Lady of Kibeho joins the universal Church in celebrating the Assumption of the Blessed Virgin Mary — a day of Mass, procession, confession, and thanksgiving.</p><p>The pilgrim office welcomes parish groups and individual pilgrims throughout the day. Please arrive early for solemn Mass, and allow time for silent prayer at the apparition sites.</p><h2>How to take part</h2><ul><li>Join the principal Mass and Marian procession</li><li>Go to confession — priests will be available through the afternoon</li><li>Pray the Rosary with fellow pilgrims</li><li>Register your group with the Pilgrimage Office if you have not already</li></ul>',
            ],
            [
            ...
            [
                ...
                'related_event_slug' => 'marian-youth-pilgrimage',
            ...
            [
                ...
                'cover_image' => '/images/sanctuary/hills.jpg',
                'related_event_slug' => 'international-pilgrimage',
